...
LIBRARY_INPUTS_ENABLED = ["ranked-pairings.csv", "authority-design-systems.csv"]
...
PROVENANCE_INPUTS_ENABLED = ["seed-designs.csv", "typefaces-ranked-pairings.csv", "palettes-authority-design-systems.csv"]
